...
The pattern looks 'non-linear' and almost seems exponential at the bottom (hardest) end.
<br> <br>
...
One way to deal with these issue is to transform the response variable.
