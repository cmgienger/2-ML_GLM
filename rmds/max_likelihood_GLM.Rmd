...
How do we interpret these coefficients and statistics? Take one minute to write down your thoughts.
...
-  **Constant variance** (a.k.a. homoscedasticity). The variance of the errors (residuals) does not depend on the values of the predictor variables.
...
-  Lack of strong **multicollinearity** in the predictors. Each predictor show provide independent information. 
