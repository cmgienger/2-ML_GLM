...
<table style="margin-left:auto; margin-right:auto; border-collapse: collapse; width: 50%; text-align: center; border: 2px solid black;">
  <thead>
    <tr>
      <th style="padding: 8px; width: 40%; border: 1px solid black;">Lambda value (λ)</th>
      <th style="padding: 8px; width: 60%; border: 1px solid black;">Transformed data (Y')</th>
    </tr>
  </thead>
  <tbody>
    <tr><td style="border: 1px solid black;">-3</td><td style="border: 1px solid black;">Y<sup>-3</sup> = 1 / Y<sup>3</sup></td></tr>
    <tr><td style="border: 1px solid black;">-2</td><td style="border: 1px solid black;">Y<sup>-2</sup> = 1 / Y<sup>2</sup></td></tr>
    <tr><td style="border: 1px solid black;">-1</td><td style="border: 1px solid black;">Y<sup>-1</sup> = 1 / Y<sup>1</sup></td></tr>
    <tr><td style="border: 1px solid black;">-0.5</td><td style="border: 1px solid black;">Y<sup>-0.5</sup> = 1 / √(Y)</td></tr>
    <tr><td style="border: 1px solid black;">0</td><td style="border: 1px solid black;">log(Y) **</td></tr>
    <tr><td style="border: 1px solid black;">0.5</td><td style="border: 1px solid black;">Y<sup>0.5</sup> = √(Y)</td></tr>
    <tr><td style="border: 1px solid black;">1</td><td style="border: 1px solid black;">Y<sup>1</sup> = Y</td></tr>
    <tr><td style="border: 1px solid black;">2</td><td style="border: 1px solid black;">Y<sup>2</sup></td></tr>
    <tr><td style="border: 1px solid black;">3</td><td style="border: 1px solid black;">Y<sup>3</sup></td></tr>
  </tbody>
</table>
...
The transformation doesn't always work well, so make sure you check your data after the transformation with a 
